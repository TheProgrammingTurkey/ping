...
function update() {
    ...
    if (velocityX > 0){
        if (ball.y > paddle1.y+paddle1Height/2 && paddle1.y < canvas.height-paddle1Height-paddle1SpeedY) {
            paddle1.y += paddle1SpeedY*movingSpeed*secondsPassed;
        }
        else if (ball.y > paddle1.y+paddle1Height/2) {
            paddle1.y = canvas.height-paddle1Height
        }
        if (ball.y < paddle1.y+paddle1Height/2 && paddle1.y > 0) {
            paddle1.y -= paddle1SpeedY*movingSpeed*secondsPassed;
        }
        else if (ball.y < paddle1.y+paddle1Height/2) {
            paddle1.y = 0
