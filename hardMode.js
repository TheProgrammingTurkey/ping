...
function update() {
    ...
    if (ball.x >= paddle2.x-10 && ball.x <= paddle2.x+posVelocityX-5 && ball.y <= paddle2.y+110 && ball.y >= paddle2.y-10){
        ...
        velocityY = Math.round(ball.y-paddle2.y-50)/ballBounciness
    ...
    if (velocityX > 0 && paddle1.y+50 > (predictedSpotY2+canvas.height/2)/2 && paddle2.x-paddle1.x > canvas.width/3){
        paddle1.y -= paddleSpeedY;
    }
    if (velocityX > 0 && paddle1.y+50 < (predictedSpotY2+canvas.height/2)/2 && paddle2.x-paddle1.x > canvas.width/3){
        paddle1.y += paddleSpeedY;
    }
    if (velocityX > 0 && paddle1.y+50 > canvas.height-(paddleHeight+70) && paddle2.x-paddle1.x < canvas.width/3){
        paddle1.y -= paddleSpeedY;
    }
    if (velocityX > 0 && paddle1.y+50 < 70 && paddle2.x-paddle1.x < canvas.width/3){
        paddle1.y += paddleSpeedY;
    }
    if (velocityX > 0 && paddle1.y+50 > predictedSpotY2 && paddle1.y > 70 && paddle2.x-paddle1.x < canvas.width/3){
        paddle1.y -= paddleSpeedY;
    }
    if (velocityX > 0 && paddle1.y+50 < predictedSpotY2 && paddle1.y < canvas.height-(paddleHeight+70) && paddle2.x-paddle1.x < canvas.width/3){
        paddle1.y += paddleSpeedY;
