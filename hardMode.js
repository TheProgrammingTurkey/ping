...
function calculate1(){
    ...
    console.log(Math.round(predictedSpotY1*1000)/1000, bounces)
}
//calculates where the ball will end up when it gets to the paddle
function calculate2(){
    ...
    else if(predictedSpotY2 > largeContact && (bounces % 2) != 0 && ball.x < canvas.width-60){
